      ...
      <div class="sm:text-center md:max-w-4xl md:mx-auto lg:col-span-12 lg:text-left">
        <h1>
          ...
          <span class="mt-1 block text-4xl tracking-tight font-extrabold sm:text-5xl xl:text-6xl">
            <span class="block">SkillTree</span>
            <span class="block text-secondary text-3xl mt-2">We're building humanity's universal map for learning!</span>
          </span>
        </h1>

		<p class="mt-3 text-base text-neutral_Light sm:mt-5 sm:text-xl lg:text-lg xl:text-xl"><i>A Young Lady's Illustrated Primer</i> (from Neal Stephenson's <i>The Diamond Age</i>) is an old dream of tech makers. SkillTree is a step towards building this and making it accessible to everyone.</p>
